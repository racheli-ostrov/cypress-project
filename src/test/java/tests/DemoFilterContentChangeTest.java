...
public class DemoFilterContentChangeTest {
    ...
    public void testDynamicContentChangeWithFiltering() {
        ...
        try {
            ...
            String firstProduct_initial = initialProducts.getFirst().getText();
            String firstProduct_sorted = sortedProducts.getFirst().getText();
            String firstProduct_final = finalProducts.getFirst().getText();
